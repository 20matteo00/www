...
// Nel template (es. templates/tuo_template/index.php, <head>)
...
?>" data-bs-theme="light">
    ...
    <div class="position-sticky sticky-top">
        <jdoc:include type="modules" name="sticky" style="none" />
    </div>
    ...
    <main class="main" id="main" role="main">
        ...
        <div class="content container">
            <div class="row">
                ...
                <div class="col">
                    <jdoc:include type="modules" name="content-top-in-sidebar" style="none" />
                    <jdoc:include type="message" />
                    <jdoc:include type="component" />
                    <jdoc:include type="modules" name="content-bottom-in-sidebar" style="none" />
                </div>
