...
return array (
  ...
  'COM_PRIVACY_DASHBOARD_BADGE_ACTIVE_REQUESTS_1' => '<span class="badge bg-warning">1</span> richiesta attiva',
  'COM_PRIVACY_DASHBOARD_BADGE_ACTIVE_REQUESTS_MORE' => '<span class="badge bg-warning">%d</span> richieste attive',
  'COM_PRIVACY_DASHBOARD_BADGE_TOTAL_REQUESTS_0' => '<span class="badge badge-info">0</span> Richieste Totali',
  'COM_PRIVACY_DASHBOARD_BADGE_TOTAL_REQUESTS_1' => '<span class="badge bg-info">1</span> Richiesta Totale',
  'COM_PRIVACY_DASHBOARD_BADGE_TOTAL_REQUESTS_MORE' => '<span class="badge bg-info">%d</span> Richieste Totali',
  ...
  'COM_PRIVACY_N_CONSENTS_INVALIDATED_1' => 'Il consenso è stato invalidato.',
  'COM_PRIVACY_N_CONSENTS_INVALIDATED' => '%d consensi sono stati invalidati.',
