...
return array (
  ...
  'COM_INSTALLER_CURRENT_VERSION' => 'Installate',
  ...
  'COM_INSTALLER_HEADING_TYPE_ASC' => 'Tipo ascendenti',
  'COM_INSTALLER_HEADING_TYPE_DESC' => 'Tipo discendenti',
  ...
  'COM_INSTALLER_MINIMUM_STABILITY_RC' => 'Candidata al rilascio',
  ...
  'COM_INSTALLER_MSG_DATABASE_ERRORS_1' => 'Un Problema',
  'COM_INSTALLER_MSG_DATABASE_ERRORS' => '%d Problemi',
  ...
  'COM_INSTALLER_MSG_DISCOVER_DESCRIPTION' => 'Scopri estensioni le estensioni che non sono state installate dal normale processo di installazione.',
  ...
  'COM_INSTALLER_MSG_N_DATABASE_ERROR_PANEL_1' => 'Trovato un problema nel Database.',
  'COM_INSTALLER_MSG_N_DATABASE_ERROR_PANEL' => 'Trovati %d problemi nel Database.',
  ...
  'COM_INSTALLER_MSG_UPDATESITES_N_DELETE_UPDATESITES_DELETED_1' => 'Il sito di aggiornamento è stato eliminato.',
  'COM_INSTALLER_MSG_UPDATESITES_N_DELETE_UPDATESITES_DELETED' => '%s siti di aggiornamento sono stati eliminati.',
  ...
  'COM_INSTALLER_MSG_WARNINGS_PHPUPLOADNOTSETDESC' => 'Questa cartella è quella che PHP usa per salvare un file caricato prima che Joomla possa accedervi. Anche se non impostare la cartella non è sempre un problema, se hai difficoltà con i file manifest che non vengono rilevati o con i file caricati che non vengono rilevati, impostare <code>upload_tmp_dir</code> nel tuo file php.ini potrebbe risolvere il problema.',
  'COM_INSTALLER_MSG_WARNINGS_PHPUPLOADNOTWRITEABLE' => 'La cartella temporanea PHP non è scrivibile',
  'COM_INSTALLER_MSG_WARNINGS_PHPUPLOADNOTWRITEABLEDESC' => 'La cartella specificata da <code>upload_tmp_dir</code> nel file php.ini non è scrivibile dall\'istanza Joomla!, il che può causare problemi durante il tentativo di caricare estensioni su Joomla. Se riscontri problemi durante il caricamento delle estensioni, controlla ‘%s’ e impostalo come scrivibile per vedere se questo risolve il problema.',
  ...
  'COM_INSTALLER_N_EXTENSIONS_PUBLISHED_1' => 'Estensione abilitata.',
  'COM_INSTALLER_N_EXTENSIONS_PUBLISHED' => '%d estensioni abilitate.',
  'COM_INSTALLER_N_EXTENSIONS_UNPUBLISHED_1' => 'Estensione disabilitata.',
  'COM_INSTALLER_N_EXTENSIONS_UNPUBLISHED' => '%d estensioni disabilitate.',
  'COM_INSTALLER_N_UPDATESITES_PUBLISHED_1' => 'Sito di aggiornamento abilitato.',
  'COM_INSTALLER_N_UPDATESITES_PUBLISHED' => '%d siti di aggiornamento abilitati.',
  'COM_INSTALLER_N_UPDATESITES_UNPUBLISHED_1' => 'Sito di aggiornamento disabilitato.',
  ...
  'COM_INSTALLER_UPDATE_MISSING_DOWNLOADKEY_LABEL_N_1' => 'Un aggiornamento di estensione non può essere installato fino a quando non <a href="%2$s">inserisci la sua chiave di download</a>.',
  'COM_INSTALLER_UPDATE_MISSING_DOWNLOADKEY_LABEL_N' => '%d aggiornamenti di estensioni non potranno essere installati fino a quando non <a href="%s">inserisci la sua chiave di download</a>.',
  ...
  'COM_INSTALLER_UPDATESITES_N_ITEMS_CHECKED_IN_1' => 'Sito di aggiornamento sbloccato.',
  'COM_INSTALLER_UPDATESITES_N_ITEMS_CHECKED_IN_MORE' => '%d siti di aggiornamento sbloccati.',
