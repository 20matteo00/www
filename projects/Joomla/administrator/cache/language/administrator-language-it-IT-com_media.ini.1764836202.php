...
return array (
  ...
  'COM_MEDIA_CREATE_NEW_FOLDER_EXISTING_FOLDER_ERROR' => 'Esistono già una cartella o un file con lo stesso nome.',
  'COM_MEDIA_CREATE_NEW_FOLDER_RELATIVE_PATH_ERROR' => 'Uso di percorsi relativi non consentito.',
  'COM_MEDIA_CREATE_NEW_FOLDER_SUCCESS' => 'Cartella creata correttamente.',
  'COM_MEDIA_CREATE_NEW_FOLDER_UNEXPECTED_CHARACTER' => 'Sono ammessi solo caratteri alfanumerici, trattini bassi(_), trattini(-) e punti(.)',
  'COM_MEDIA_DECREASE_GRID' => 'Diminuisci dimensioni della griglia',
  'COM_MEDIA_DELETE' => 'Sei sicuro di voler eliminare l\'elemento(i) selezionato(i)? Questa azione è permanente e non può essere annullata. Se si elimina una cartella, tutto il suo contenuto sarà rimosso in modo permanente.',
